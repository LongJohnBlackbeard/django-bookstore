...
class UserEditForm(forms.ModelForm):
    ...
    phone_number = forms.CharField(
        label='Phone Number', min_length=10, max_length=31, widget=forms.TextInput(
            attrs={'class': 'form-control mb-3', 'placeholder': 'Phone Number', 'id': 'form-phone_number'}))

    postcode = forms.CharField(
        label='Postal Code', min_length=5, max_length=12, widget=forms.TextInput(
    ...
    address_line_2 = forms.CharField(
        label='Address Line 2', required=False, max_length=150, widget=forms.TextInput(
            attrs={'class': 'form-control mb-3', 'placeholder': 'Address Line 2', 'id': 'form-address_line_2'}))

    town_city = forms.CharField(
        label='Town/City', min_length=3, max_length=50, widget=forms.TextInput(
